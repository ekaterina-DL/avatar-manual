...
MAPPINGS = [
    ...
    },
    {
        ...
        # Первые 3 видео переиспользованы (скопированы, оригинал сохранён) из 07-example-
        # library.md, "Топ-5 ошибок", пункт 4 "Движение камеры (ошибка в оценке)" — см. комментарий
        # у поля 6 выше про то, почему раздел "Топ-5" не удаляется целиком. Четвёртое — новое,
        # найдено 20.08.2026 в "АВАТАР 3 ЭТАП.pdf": контрастный пример НАСТОЯЩЕГО "moving"
        # (плавное движение, без тряски) — в остальных 3 примерах речь только о пропущенном shaky.
        "target_file": "manual-3-etap/01-classifier.md",
        ...
        "items": [
            ...
            "  [пример](https://gigaeye-kandinsky-spark.obs.ru-moscow-1.hc.sbercloud.ru/ak/avatar/0a74208b-b92f-4236-855b-661eb57c1ddc/trimmed/-165317374_456239032__segment_6_174_213__seg5.mp4)",
        ],
        "max_items": 2,
