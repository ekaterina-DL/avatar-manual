...
MAPPINGS = [
    ...
    },
    {
        ...
        # Первые 3 видео переиспользованы (скопированы, оригинал сохранён) из 07-example-library.md,
        ...
        #
        # 04.09.2026: последние 4 пункта (shaky ×2, moving ×2) добавлены при переносе раздела
        # "Тряска камеры vs плавное движение" с manual-2-etap/05b-what-not-to-label.md — заказчик
        # в комментариях к мануалу 2 этапа прямо указал, что эти примеры относятся к 3 этапу
        # (комментарии к пунктам о тряске), что и подтверждает уже сделанная 25.08.2026 находка
        # выше (тот же первоисточник — таблица «12-й вопрос. Движение камеры»). До этой правки
        # у поля не было ни одного примера "moving" — теперь есть. Раздел на 2 этапе удалён
        # целиком, дублей не создано (grep по репозиторию перед переносом).
        ...
        "items": [
            ...
            "- **shaky:**\n"
            "  [пример 4](https://gigaeye-kandinsky-spark.obs.ru-moscow-1.hc.sbercloud.ru/kandi_de_team/post_train/stage2/video/avatars/b60f390b-7303-41bb-9e9e-0e343784d30a/trimmed/xNQsedaNa9Y__segment_239139406_254170148.mp4)",
            "- **shaky:**\n"
            "  [пример 5](https://gigaeye-kandinsky-spark.obs.ru-moscow-1.hc.sbercloud.ru/kandi_de_team/post_train/stage2/video/avatars/b60f390b-7303-41bb-9e9e-0e343784d30a/trimmed/ufdhq0PS7Dw__segment_221050564_242622565.mp4)",
            "- **moving (плавное движение, для контраста с shaky):**\n"
