...
- **Лицо в кадре:** главный объект — голова, плечи, руки человека. Лицо должно быть хорошо
  ...
  течение всего сегмента — отворот-поворот лица, из-за которого человек полностью теряется из
  кадра, сегмент не подходит. Ключевые точки лица (губы, глаза), движение рта, глаз, рук (если
  руки в кадре) — чётко различимы: в фокусе, не размыты, не «смазаны». Движения губ
  (артикуляция) должны чётко соответствовать произносимой речи — без лага по времени, без
  «замыливания» изображения губ. Мимика должна быть естественной, не преувеличенной.
