...
<!-- СКРИНШОТ ЖДЁТ ФАЙЛА: положить кадр в assets/perezhatie-nfjovty-frame.jpeg и раскомментировать
блок ниже (ссылка на скриншот приходила Gmail-вложением, скачать напрямую нельзя).
...
Пример не такой очевидный, как кажется, но при увеличении изображения можно увидеть сильные
