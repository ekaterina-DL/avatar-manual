...
<ul class="dash-list">
<li>на долю секунды — допустимо, сегмент из-за этого обрезать не нужно (и то лишь если это не
приходится ровно на момент речи — см. точный ориентир ниже).</li>
<li>более длительное (например, стаканом на 4 секунды) уже требует корректировки границ
сегмента (исключить проблемный участок) — на практике именно такой случай зафиксирован
как реальная ошибка «Некорректные границы объекта».</li>
</ul>
