...
- **Как отличить пикселизацию лица на глаз**, если она неочевидна с первого взгляда: лучше всего
  ...
  [«Банк примеров»](11-example-library.md#большая-пиксельность-23-примеров).
...
- Тряска камеры или её сильное «гуляние» — сегмент не подходит. Рабочий критерий, подтверждённый
  ...
  по этой эвристике). `[Памятка «Аватар 2 этап», стр.3; Вопросы-ответы, 20.08.2026]`
...
- **Практический приём для поиска скрытой склейки/смены кадра рядом с краем сегмента:** поля
  точной подгонки границ («Начало»/«Конец», см.
  ...
  подвигайте границу покадрово туда-обратно: если рядом есть склейка, будет резко заметно
  изменение (например, руки внезапно оказались в другом положении, изменился рост/масштаб
