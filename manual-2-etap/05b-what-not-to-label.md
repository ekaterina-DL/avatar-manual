...
Здесь собрано всё, из-за чего видео или сегмент не подходит: чек-лист исключений, детальные
критерии по каждому пункту, когда и как видео помечается «Битое», антипримеры для калибровки.
...
[01-general-requirements.md](01-general-requirements.md) (в самом начале страницы).
