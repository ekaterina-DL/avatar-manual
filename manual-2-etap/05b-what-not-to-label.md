...
- **Пережатие (компрессионные артефакты)** — особенно заметно на руках и губах — на всём
  ...
  что движется) появляются **чёрные горизонтальные полосы**. Заказчик подтвердил: это брак,
  такое видео отправляется в «Битое». `[Ответы на вопросы по Аватару, 02.09.2026; Разметка ВК
  видео — ОС 01.09.2026]`
...
- **Молчание внутри сегмента** не должно превышать **3–5 секунд**. Короткая пауза (1–2 сек) —
  **не повод** резать сегмент. Короткий кашель, шмыганье носом, смешок «на вдохе» — это не
  ...
  ⚠️ **На границах (в самом начале и в самом конце) молчания быть не должно вообще** — заказчик
  подтвердил это напрямую (02.09.2026). Более раннее правило допускало здесь до 2–3 секунд
  молчания «про запас» — это более старая, более мягкая формулировка; сегмент должен начинаться
  и заканчиваться **ровно на речи**, без запаса тишины по краям.
  `[Ответы на вопросы по Аватару, 02.09.2026]`
...
<p markdown="1">⚠️ **Точный ориентир по времени, подтверждённый заказчиком (02.09.2026):** перекрытие лица
допустимо на **1–2 секунды** (почесать нос, поправить очки и т.п.), но **только если это не
происходит в момент речи**. Если рот перекрыт рукой/предметом именно тогда, когда человек в
этот момент говорит — такой участок в сегмент включать нельзя, даже если он короткий.
...
(бликов, отражённого света и т.п.), закрывающих обзор на глаза; заказчик подтвердил это
отдельно (02.09.2026). `[Ответы на вопросы по Аватару, 02.09.2026]`
