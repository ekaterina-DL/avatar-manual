...
движение камеры похожее на съёмку **на бегу** («если человек бежит и что-то снимает»); (2)
из-за тряски появляются **эффекты смазанности/размытости** картинки — тогда это «Битое». Если
ни то, ни другое не применимо — такое «гуляние» допустимо, даже если камера не абсолютно
статична.
