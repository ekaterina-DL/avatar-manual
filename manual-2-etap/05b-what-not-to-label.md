...
- Если в кадре **два человека**, но один из них повёрнут к нам **спиной или больше чем в профиль**
  — по аналогии с очками, это допустимо при условии, что повёрнутый человек **молчит**, а рядом
  **чётко говорит человек с видимым лицом**: такой кадр можно размечать целиком, в классификаторе
