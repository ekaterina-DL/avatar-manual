...
- ⚠️ «Гуляние» камеры само по себе — не проблема, если оно **не мешает восприятию происходящего
...
<p markdown="1">**Солнцезащитные очки** — допустимы, **кроме** случаев, когда через них совсем не видно глаз
**у говорящего человека**. Реальный пример брака по этой причине — тёмные очки, полностью
скрывающие глаза.
`[Памятка «Аватар 2 этап», стр.3; Инстр. Kandinsky-Аватар, стр.2, 7-10; Разметка ВК видео —
ОС 22.05 СТ2]`</p>

<p markdown="1">💡 Модели для обучения не нужны говорящие люди с закрытыми/невидимыми глазами — поэтому если
...
<p markdown="1">⚠️ Даже если очки прозрачные и глаза видны — в них **не должно быть отражений**
