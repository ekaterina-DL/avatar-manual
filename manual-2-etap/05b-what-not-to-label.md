...
Пережатие (компрессионные артефакты; в других формулировках встречается также как «пожатие» —
это один и тот же дефект) — особенно заметно на руках и губах — на всём протяжении сегмента
делает его непригодным. `[ОС заказчика, 17.07.2026; Комментарии к мануалу от заказчика,
08.09.2026]`
...
склейке — см. [«Склейки»](#склейки) в разделе «Полностью исключённые типы видео».
