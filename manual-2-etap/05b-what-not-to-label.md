...
одной непрерывной сценой без резких монтажных переходов. Как правильно ставить границу сегмента
рядом со склейкой — см. [«Склейка»](#склейка) в разделе «Исключения, зависящие от степени и контекста».
...
камеры, а не сам факт, что она двигается.

<div class="field-label-row" markdown="1">

### Склейка {: .field-label-heading }

Резкий скачок камеры внутри сегмента приравнивается к склейке — это брак; насколько скачок
заметен и критичен, оценивается на глаз, по аналогии с зумом.

</div>

**Калибровочный пример:**

<!-- video-eyebrow: Склейка -->
