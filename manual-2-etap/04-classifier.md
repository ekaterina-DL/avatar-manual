...
⚠️ **Поза тоже важна, не только факт, что колено видно в кадре.** Если человек сидит, поджав
колени к груди и обхватив их руками — верхняя часть колена рядом с грудью/лицом **не считается**
тем самым «видны колени» для «в полный рост». Критерий — видны ли **бёдра вместе с коленями** в
обычной, вытянутой позе (как при обычном сидении на стуле/полу), а не фрагмент колена в свёрнутой
позе. Реальный кейс: девушка сидит, обняв руками поджатые к груди колени (видна только верхняя
часть колена и кисть с кольцом) — асессор поставил «Сидя, в полный рост», правильный ответ —
«Голова, плечи и руки». Комментарий валидатора: «Ошибка классификатора: должно быть "голова,
плечи и руки". Колени на уровне груди видны, в полный рост ставить, когда хотя бы бёдра с
