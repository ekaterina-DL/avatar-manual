...
проверяемым правильным ответом, не «оценочные», как часть остальных полей классификатора
(например, освещение). По практическому опыту команды заказчик регулярно и болезненно реагирует
именно на ошибки в них — примеры см. в [«Частые ошибки»](06-common-mistakes.md#1-ошибка-классификатора).
