...
- **Фон с виньеткой** — наложенный эффект, брак, если во всём видео нет сегмента без неё; полная
  формулировка правила — [03-video-quality.md](03-video-quality.md#артефакты-из-за-которых-сегмент-не-подходит),
