...
Цель по команде в целом — равномерное распределение от медленного и чёткого до быстрого.
...
В банке примеров ниже для калибровки поля показан ещё и «средний темп» — это не третье
