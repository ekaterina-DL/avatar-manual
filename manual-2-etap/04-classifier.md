...
- **Фон с виньеткой:** ⚠️ **не решено, см. спор** — по одному источнику, если фон однотонный,
  но по краям картинки чуть темнее (эффект виньетки, круглая/квадратная засветка по центру) —
  это всё ещё считается **однотонным фоном**, а не отдельной категорией и не бракует видео.
  `[FAQ «Примеры», дополнено 13.03]` — пример смотри в
  [11-example-library.md](11-example-library.md#пример-однотонного-фона-с-виньеткой). Но на
  3 этапе виньетка — прямой критерий «битого», и источник этого правила для 2 этапа сам
  оказался частично 3-этапным документом — подробности и статус см.
  [09-disputed-points.md](09-disputed-points.md#виньетка-на-видео-это-битое-3-этап-или-просто-однотонный-фон-2-этап--новое).
