...
из них говорит/поёт (пример пропущенной отметки — в [Журнал проверок ОС](10-qa-log.md)).
Неофициальное разъяснение, но соответствует и подтверждает логику официального правила.
`[Чат исполнителей, 11.08.2026]`
