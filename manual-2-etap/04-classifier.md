...
⚠️ Значение должно быть **консистентным по всему сегменту**: если руки то появляются, то
...
⚠️ В банке примеров ниже для калибровки поля показан ещё и «средний темп» — это не третье
значение классификатора (в нём только «Медленный»/«Быстрый»), а ориентир, ближе к какому из
двух значений находится конкретное видео.
...
- **Студия** — искусственная среда (фотостудия, съёмка шоу).
- **Естественная среда** — обычная бытовая обстановка (кабинеты, улица и т.д.).

⚠️ Ключевой критерий — не сам фон, а то, **подготовлена ли среда специально для съёмки**:
корпоративные видео, интервью на нейтральном фоне, лекции и стримы с хорошим оборудованием —
это «Студия» (профессиональное освещение и звук, нейтральный статичный фон); подкасты,
видеоблоги, видеозвонки и интервью на улице — «Естественная среда» (камера статична или
движется плавно, свет и фон могут быть неидеальными, слышны лёгкие фоновые звуки). Обычная
жилая квартира с нейтральной стеной — это всё ещё «Естественная среда», а не «Студия», если
не выглядит специально подготовленной для съёмки. `[Инстр. Kandinsky-Аватар, стр.2; Разметка
ВК видео — ОС Экзамен 18.05 СТ2]`
