...
(например: «Объём и поза тела»: Голова и плечи; «Преобладающий ракурс»: Анфас). Один человек
в кадре → один ответ на вопрос.
...
В остальных случаях — один ответ на один вопрос.
