...
- Если человек постоянно **поворачивает голову (то анфас, то профиль, то полуоборот)** и
  ...
  **преобладает** по факту в выбранном сегменте (обычно анфас, если камера расположена перед
  ...
  этап]`
- **Практический критерий «профиль vs потеря лица»:**
...
- Если по всему сегменту ракурс делится примерно **50/50 между двумя значениями и явно
...
- На практике «Сложное» освещение встречается крайне редко — в подавляющем большинстве
...
**Что считается «подготовленным», а что «спонтанным»:** подготовленный монолог — заученная
или срежиссированная речь (лекции, презентации, новости, актёрские видеовизитки; чёткая
дикция, минимум пауз и оговорок). Спонтанный монолог — неподготовленная речь (влоги, рассказы,
размышления вслух, а также ответы на вопросы интервьюера за кадром — после того как сам
закадровый вопрос убран из сегмента, см. ниже). Примеры каждого значения — в
[банке примеров](11-example-library.md#тип-речи-диалог-монолог-и-закадровый-голос).
