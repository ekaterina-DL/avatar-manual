...
⚠️ Если кадр обрезан прямо по линии колен без запаса выше, это лучше отнести к «Голова, плечи
и руки». `[FAQ «Примеры», дополнено 13.03; Встреча с новичками по 2 этапу, 29.07.2026]`

⚠️ Если в кадре видны только колени (часть колена), а бёдра не видны (например, человек сидит
