...
Классификатор в интерфейсе разметки состоит из **13 полей**. Ниже — каждое поле отдельным
блоком по порядку: значения, затем нюансы заполнения (каждый — с новой строки).
...
Возраст и т.д.), см. [«Общее правило выбора значений»](#общее-правило-выбора-значений) выше.
