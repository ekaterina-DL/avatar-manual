...
⚠️ Поле проставляем **по фактическому числу видимых людей**, независимо от того, кто из них
...
⚠️ Одна из самых частых ошибок в реальных проверках — засчитывать случайных людей на фоне:
правильный ориентир — **считаем только того, кого снимает камера** (главного спикера и тех,
кто стоит с ним рядом в кадре), мимо проходящие/фоновые люди не в счёт.
