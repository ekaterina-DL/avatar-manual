...
— на реальном экзамене торопиться не стоит, важнее не пропустить склейку или смену кадра; в
сомнительных участках видео можно и нужно замедлять.
...
> 🆕 На скриншоте выше этого ещё нет (добавлено позже): с 03.09.2026 справа от кнопки «Битое»
> появилась кнопка **«Проиграть фрагмент видео»** — позволяет воспроизвести только выбранный
> сегмент, а не всё видео целиком. Подробности и как пользоваться — см.
...
При работе с видео смотрите его на обычной скорости x1 — увеличивать скорость не нужно, так
можно легко пропустить артефакт (например, склейку); а в сомнительных участках, наоборот, можно
и нужно замедлять просмотр. `[Комментарии для мануала ко 2 этапу Аватара, 04.09.2026]`
...
хороший результат, но он не отменяет необходимости знакомиться с ОС по своим ошибкам. Если
результат **ниже нормы** — нужно **срочно** пересмотреть свои ответы в сервисе «Мои ответы»,
...
[мануал 3 этапа](../manual-3-etap/00-overview.md#как-оценивается-качество-работы)), на 2 этапе каждое задание, и
экзаменационное, и обычное рабочее, дополнительно проверяет валидатор **вручную**: он оставляет
комментарии по каждому асессору (см. «Мои ответы») и дополнительно даёт обратную связь через
руководителя группы (см. ниже). Решения о предупреждениях/отключении принимаются по совокупности
найденных валидатором ошибок (см. ниже), а
не по одному проценту прохождения контрольных заданий.
