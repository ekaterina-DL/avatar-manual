...
| **«Битое» видео** | Если на видео нет ни одного сегмента, подходящего под критерии, всё видео помечается галочкой «Битое» (вместо выделения сегментов) — это два взаимоисключающих варианта, никогда не то и другое одновременно. Если до вердикта «Битое» уже были выделены сегменты — их нужно **обязательно удалить**, и только потом ставить галочку (частая ошибка — сегмент и «Битое» стоят одновременно). `[Инстр. Kandinsky-Аватар, стр.1; ОС заказчика, 17.07.2026; Видео с разбором ошибок — Аватар 2 этап]` |
...
экзамен и допуск к рабочим пулам.
