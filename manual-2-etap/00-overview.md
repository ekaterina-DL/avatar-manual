...
<div class="kf-stats">
<div class="kf-stat">
<div class="kf-value">10<span>заданий/день</span></div>
<div class="kf-label">минимум на одну заявку (умножается на число заявок)</div>
</div>
<div class="kf-stat">
<div class="kf-value">50<span>заданий/нед.</span></div>
<div class="kf-label">резерв по конкретной заявке, если в ней закончились задания</div>
</div>
<div class="kf-stat">
...
**Ежедневный минимум** — не менее **10 заданий по каждой заявке**, которую ведёт асессор (26,
27, 28), и норма **умножается на количество заявок**: две заявки — 20 заданий в день, три — 30
и т.д. Это правило именно про число заявок, а не про суммарный объём — недельный резерв ниже
его не заменяет.

**Исключение — недельный резерв, но только по конкретной заявке.** Если по какой-то из заявок
в моменте физически закончились задания (пустая очередь), норму по **этой заявке** можно
выполнить суммарно за неделю — не менее **50 заданий по ней за неделю**, без требования делать
её каждый день. На остальные заявки, где задания есть, это исключение не распространяется — там
дневная норма действует как обычно.

**Отключение от проекта** происходит при **неактивности дольше 14 дней подряд** или при
**невыполнении нормы** (тоже помимо решения из-за качества работы — см.
[ниже](#как-оценивается-качество-работы)). Для возврата к работе после отключения нужно заново
пройти [тестирование](07-testirovanie.md) и входной [экзамен](#экзамен-и-допуск), как при
первом приходе на проект.

**Допуск к 3 этапу** (заявка 46) даётся только при условии выполнения нормы по всем ведущимся
заявкам.

`[Уточнение пользователя, 18.09.2026]`
