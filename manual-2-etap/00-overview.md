...
| Термин | Определение |
|---|---|
| **Сегмент** | Непрерывный фрагмент видео длительностью **от 10 до 300 секунд**, без артефактов (смена кадра, склейки, рамки, водяные знаки, наложенный текст и т.д.), пригодный для обучения модели. На одном видео сегментов может быть несколько, у каждого — свой классификатор. Подробные критерии — [02-segments.md](02-segments.md). `[Инстр. Kandinsky-Аватар, стр.1]` |
