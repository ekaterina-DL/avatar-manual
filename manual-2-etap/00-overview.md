...
нужно пройти **новое обязательное тестирование на платформе Tagme** — [ссылка на
...
— и сдать [экзамен](#экзамен-и-допуск). Это отдельное тестирование: оно не совпадает со
стандартным входным экзаменом и с [тестированием по 2 этапу](07-testirovanie.md) на этом сайте.

**Допуск к 3 этапу** (заявка 46) даётся только при условии выполнения еженедельной нормы.

`[Уточнение пользователя, 18.09.2026; Ответы заказчика на вопросы из разных писем, 21.09.2026]`
