...
Экзамен (см. [«Экзамен и допуск»](00b-exam.md)) и рабочие задания выполняются на платформе Tagme,
в личном кабинете каждого асессора. Доступ к платформе выдаёт **руководитель группы Data Light**.

Общение с руководителем группы и остальными участниками проекта (асессорами), а также
дополнительные материалы по проекту — в приватном канале **«TAG ME Аватары»**; доступ к нему
руководитель группы открывает после успешной сдачи экзамена.
