...
обращения и может поправить валидатора, а не автоматически встаёт на его сторону. Подтверждённые
реальные случаи: заказчик встал на сторону оператора против нового валидатора
([07-faq.md](07-faq.md#можно-ли-оспорить-решение-валидатора-да--и-заказчик-может-встать-на-сторону-оператора));
