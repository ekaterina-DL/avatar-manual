...
Самое важное в работе — правильно найти и выделить [сегмент](02-segments.md): требования к качеству
самого выбора сегмента (не пропустить водяной знак/рамку/склейку, найти подходящий «золотой кадр»
среди монтажа) жёсткие, и именно по ним чаще всего прилетают серьёзные ошибки. `[Видео с разбором
ошибок — Аватар 2 этап]`

Заполнение классификатора при этом не «неважно» — просто устроено иначе: формального порога
согласованности ответов между асессорами нет, большинство полей прямо признаны оценочными (см.
[04-classifier.md](04-classifier.md#поля-классификатора)). Исключение — **пол и язык**: их заказчик проверяет
так же строго, как границы сегмента. А поля **«Объём и поза тела»**, **«Тип речи»**, **«Количество людей в
кадре»** и **«Баланс по пению/говорению»** на практике — самые частые источники ошибок классификатора и
предупреждений исполнителям; подробный разбор — в
