...
<div class="kf-label">минимум по каждой заявке</div>
</div>
<div class="kf-stat">
<div class="kf-value">50<span>заданий/нед.</span></div>
<div class="kf-label">минимум суммарно за неделю (если задания на заявке закончились)</div>
</div>
<div class="kf-stat">
...
27, 28). Если на какой-то из заявок задания закончились, разрешается компенсировать за счёт
других заявок — суммарно не менее **50 заданий в неделю**.

**Отключение от проекта** происходит при **неактивности дольше 14 дней подряд** или при
**невыполнении еженедельной нормы** (тоже помимо решения из-за качества работы — см.
...
**Допуск к 3 этапу** (заявка 46) даётся только при условии выполнения еженедельной нормы (50
заданий в неделю).
