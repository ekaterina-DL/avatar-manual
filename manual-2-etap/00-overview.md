...
**Пропустить кейс нельзя.** Каждое видео в рабочем пуле нужно разметить. Если кейс сложный или
нужна пауза — выйдите на перерыв (15–30 минут, в зависимости от заявки) или переключитесь на
другую заявку: кейс останется за вами и освободится для другого асессора только когда истечёт
отведённое на него время. Это организационное правило платформы, а не критерий разметки.
...
Допуск к 2 этапу даёт только входной экзамен. Каждое задание вручную проверяет валидатор, а
обратную связь передаёт руководитель группы; итог — % верных ответов.

| | ✅ Набрано ≥80 % | ❌ Меньше 80 % |
|---|---|---|
| **Попытка 1**<br>10 заданий | Доступ к рабочим пулам (заявки 26/27/28) откроется сразу | Валидатор даёт обратную связь по всем ошибкам — **обязательно учтите её** перед пересдачей. Открывается попытка 2 |
| **Попытка 2**<br>10 **других** видео | Доступ к рабочим пулам откроется | 🚫 **«Экзамен не сдан»** — результат финальный, третьей попытки нет |

`[Переписка в Telegram с заказчиком, 04.02.2026; Разметка ВК видео — ОС Экзамен 18.05 СТ2 и ОС
экзамен 2 этап 05.08; Почта DataLight — Re: Результаты экзамена (2 этап. Аватар), 28.07.2026;
Встреча с новичками по 2 этапу, 29.07.2026]`

💡 **На экзамене смотрите видео на скорости x1** (не ускоряйте): важнее не пропустить склейку или
смену кадра. В сомнительных местах видео можно и нужно **замедлять**.
...
4. **Не дробите лишнее.** Если между фрагментами нет артефакта и они не отличаются ракурсом,
   ...
   Полностью идентичных сегментов достаточно одного; если условия отличаются — сегментов с одним
   и тем же человеком не больше трёх (с 25.09.2026).
