...
прямоходящие (передвигаются на двух ногах, как человек). Точные критерии, разбор пограничных
случаев (поза и поведение животного, качество анимации) и калибровочная таблица персонажей —
см. [01-general-requirements.md](01-general-requirements.md#мультики-и-антропоморфы).
