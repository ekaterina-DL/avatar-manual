...
<div class="kf-label">минимум на одну заявку</div>
</div>
<div class="kf-stat">
<div class="kf-value">50<span>заданий/нед.</span></div>
<div class="kf-label">минимум на одну заявку за неделю</div>
</div>
<div class="kf-stat">
...
**Норма — 10 заданий в день на каждую заявку**, которую ведёт асессор (26, 27, 28), и она
**умножается на количество заявок**: одна заявка — 10 заданий в день (50 в неделю), две — 20 в
день (100 в неделю), три — 30 в день (150 в неделю).

**Неделя вместо жёсткого дневного графика.** Норму не обязательно закрывать строго поровну
каждый день — если распределяете нагрузку неравномерно (например, работаете преимущественно по
выходным) или на какой-то из заявок в моменте закончились задания, достаточно выполнить
недельную сумму целиком (**50 × количество ведущихся заявок**).
