...
<div class="kf-stats">
<div class="kf-stat">
<div class="kf-value">10<span>заданий</span></div>
<div class="kf-label">ежедневный минимум по каждой заявке</div>
</div>
<div class="kf-stat">
<div class="kf-value">14<span>дней</span></div>
<div class="kf-label">неактивность → нужны новые тестирование и экзамен</div>
</div>
</div>
</div>

**Ежедневный минимум** — не менее **10 заданий по каждой заявке**, которую ведёт асессор (26,
27, 28) — это управленческий норматив по объёму работы, а не критерий разметки.

**При отключении от проекта** (по решению из-за качества работы — см. [ниже](#как-оценивается-качество-работы))
**или при неактивности дольше 14 дней подряд** — для возврата к работе нужно заново пройти
[тестирование](07-testirovanie.md) и входной [экзамен](#экзамен-и-допуск), как при первом
приходе на проект.
