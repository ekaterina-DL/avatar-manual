...
⚠️ **Вес ошибки по сегменту и по классификатору одинаковый** — заказчик не делит ошибки на
«грубые» и «негрубые»: любая из категорий ниже учитывается наравне с остальными.
